...
ZSH_HIGHLIGHT_HIGHLIGHTERS=(brackets main cursor regexp pattern)
...
ZSH_HIGHLIGHT_REGEXP+=('\<sudo\>' fg=#ff0000,bold)
ZSH_HIGHLIGHT_REGEXP+=('\<rm -rf\>' fg=#ff0000,bold)
ZSH_HIGHLIGHT_REGEXP+=('\<error\>' fg=#ff0000,bold)